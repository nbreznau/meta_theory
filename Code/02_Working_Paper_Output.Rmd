...
set_matrix_full_X124 <- subset_models(set_matrix= set_matrix_full,
                                 cmp_matrix = cmp_matrix,
                                 keep_only = c("X1", "X2", "X4"))

set_matrix_7_X124 <- subset_models(set_matrix = set_matrix_7,
                                 cmp_matrix = cmp_matrix,
                                 keep_only = c("X1", "X2", "X4"))

set_matrix_full_7_X124 <- subset_models(set_matrix= set_matrix_full_7,
                                 cmp_matrix = cmp_matrix,
                                 keep_only = c("X1", "X2", "X4"))
```
